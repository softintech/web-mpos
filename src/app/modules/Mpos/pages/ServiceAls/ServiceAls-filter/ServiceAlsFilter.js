...
export function ServiceAlsFilter({ listLoading,name}) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(ServiceAlsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, ServiceAlsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      ServiceAlsUIProps.setQueryParams(newQueryParams);
    }
  };
              ...
              <div className="col-lg-6" >
                <div className="float-sm-right">
                  <button
                      ...
                      onClick={ServiceAlsUIProps.newShopsPageCreshopButtonClick}
                      >{name}
                  </button>
                </div>
