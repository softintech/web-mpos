...
// Validation schema
const ResultEditSchema = Yup.object().shape({
  ...
  return (
    <>
      <Formik
        ...
        validationSchema={ResultEditSchema}
        onSubmit={(values) => {
          saveResult(values);
        }}
      >
            ...
            <Modal.Body className="overlay overlay-block cursor-default col-12">
              ...
              <Form className="form form-label-right d-flex row">
                ...
                <Card className="col-md-8" aria-labelledby="example-modal-sizes-title-lg">
                  <ResultEditDialogHeader id={id} onHide={onHide} />
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-lg-4">
                      <Field
                        ...
                        label="IP Address"
                        customFeedbackLabel="We'll never share Result IP Address with anyone else"
                      />
                    </div>
                  </div>
                  <div className="form-group row">
