...
export function StockMatsFilter({ listLoading,name}) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(StockMatsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, StockMatsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      StockMatsUIProps.setQueryParams(newQueryParams);
    }
  };
              ...
              <div className="col-lg-6" >
                <div className="float-sm-right">
                  <button
                      ...
                      onClick={StockMatsUIProps.newShopsPageCreshopButtonClick}
                      >{name}
                  </button>
                </div>
